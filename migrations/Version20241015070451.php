...
final class Version20241015070451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE storage (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, laneNumber INT NOT NULL, INDEX IDX_547A1B344D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

...
var FullCalendar = (function (e) {
    ...
    function p(e, n, r) {
        ...
        if (
            (arguments.length > 2 && (a.children = arguments.length > 3 ? t.call(arguments, 2) : r), "function" == typeof e && null != e.defaultProps)
        )
    ...
    n.__e = function (e, t, n, r) {
        if (e.then)
            for (var i, s = t; (s = s.__); ) if ((i = s.__c) && i.__c) return null == t.__e && ((t.__e = n.__e), (t.__k = n.__k)), i.__c(e, t);
        se(e, t, n, r);
    };
    var oe = n.unmount;
    function ae() {
    ...
    n.vnode = function (e) {
        ...
        if ("string" == typeof t) {
            ...
            "select" == t &&
                ...
                (e.props = r),
                n.class != n.className &&
                    ((Ae.enumerable = "className" in n), null != n.className && (r.class = n.className), Object.defineProperty(r, "className", Ae));
        }
        (e.$$typeof = ge), De && De(e);
    };
    var we = n.__r;
    ...
    function nt(e) {
        let t,
            ...
            i = [];
        for (
            "string" == typeof e ? (i = e.split(/\s*,\s*/)) : "function" == typeof e ? (i = [e]) : Array.isArray(e) && (i = e), t = 0;
            t < i.length;
            t += 1
        )
            (n = i[t]),
    ...
    class Hn {
        ...
        diffWholeYears(e, t) {
            ...
            return zt(e) === zt(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(e) === n.getMarkerMonth(t)
            ...
            if (i) {
                ...
                r &&
                    i(
                        Object.assign(
                            Object.assign(
                                { id: this.id, isActive: e, containerEl: this.base, reportNewContainerEl: this.updateElRef, generatorMeta: r },
                                n
                            ),
    ...
    class gr {
        ...
        build(e, t, n = !0) {
            ...
            return (
                ...
                n &&
                    ((d = e), (e = null != (u = r).start && d < u.start ? u.start : null != u.end && d >= u.end ? new Date(u.end.valueOf() - 1) : d)),
        ...
        adjustActiveRange(e) {
            let { dateEnv: t, usesMinMaxTime: n, slotMinTime: r, slotMaxTime: i } = this.props,
                { start: s, end: o } = e;
            return (
                n && (vt(r) < 0 && ((s = Mt(s)), (s = t.add(s, r))), vt(i) > 1 && ((o = Mt(o)), (o = wt(o, -1)), (o = t.add(o, i)))),
                { start: s, end: o }
            );
        }
    ...
    function Yr(e, t, n) {
        n.emitter.trigger(
            "select",
            Object.assign(Object.assign({}, Zr(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view })
        );
    }
    function Zr(e, t) {
        let n = {};
        ...
        toPlainObject(e = {}) {
            ...
            return (
                ...
                e.collapseColor && n.backgroundColor && n.backgroundColor === n.borderColor
                    ...
                    : (n.backgroundColor && (s.backgroundColor = n.backgroundColor), n.borderColor && (s.borderColor = n.borderColor)),
    ...
    function pi(e, t, n, r, i, s, o) {
        ...
        return c && !u.allDay && (v || y)
            ? ((p = v ? f : p),
              (m = y ? g : m),
              d && u.hasEnd
                  ? a.formatRange(p, m, t, { forcedStartTzo: s ? null : h.forcedStartTzo, forcedEndTzo: o ? null : h.forcedEndTzo })
    ...
    class Ni {
            ...
            if (e instanceof ti) {
                ...
                return (
                    this.getCurrentData().eventStore.defs[t.defId] ||
                        (this.dispatch({ type: "ADD_EVENTS", eventStore: Rr({ def: t, instance: n }) }), this.triggerEventAdd(e)),
                    e
                );
            }
            let n,
        ...
        addEventSource(e) {
            ...
            if (e instanceof ei)
                return (
                    t.eventSources[e.internalEventSource.sourceId] || this.dispatch({ type: "ADD_EVENT_SOURCES", sources: [e.internalEventSource] }),
                    e
                );
            let n = jr(e, t);
    ...
    function Xi() {
        return (
            null === Zi &&
                (Zi = (function () {
                    let e = document.createElement("div");
                    Be(e, { position: "absolute", top: -1e3, left: 0, border: 0, padding: 0, overflow: "scroll", direction: "rtl" }),
                        (e.innerHTML = "<div></div>"),
                        document.body.appendChild(e);
    ...
    class cs {
        ...
        insertEntryAt(e, t) {
            ...
            -1 === t.lateral ? (gs(r, t.level, t.levelCoord), gs(n, t.level, [e])) : gs(n[t.level], t.lateral, e),
        ...
        findInsertion(e) {
            ...
            return (
                ...
                { touchingLevel: a, touchingLateral: l, touchingEntry: c, stackCnt: d, levelCoord: o, level: u, lateral: h }
            );
        }
        toRects() {
    ...
    function Es(e, t) {
        return an(
            !e || t > 10 ? { weekday: "short" } : t > 1 ? { weekday: "short", month: "numeric", day: "numeric", omitCommas: !0 } : { weekday: "long" }
        );
    }
            ...
            return p(
                Jn,
                {
                    ...
                    elAttrs: Object.assign(
                        { role: "columnheader", colSpan: i.colSpan, "data-date": a.isDisabled ? void 0 : Wt(s) },
                        i.extraDataAttrs
                    ),
                    renderProps: u,
                ...
                (e) =>
                    p(
                        ...
                        !a.isDisabled && p(e, { elTag: "a", elAttrs: d, elClasses: ["fc-col-header-cell-cushion", i.isSticky && "fc-sticky"] })
                    )
            );
        }
    }
    ...
    class Rs extends D {
        ...
        computeTiming() {
            ...
            return (
                (s = Math.min(864e5, s)), { currentState: { nowDate: r, todayRange: xs(r) }, nextState: { nowDate: i, todayRange: xs(i) }, waitMs: s }
            );
        }
        setTimeout() {
        ...
        render() {
            ...
            return p(Rs, { unit: "day" }, (e, o) =>
                p(
                    ...
                    t.map((e) =>
                        r
                            ? p(Ds, { key: e.toISOString(), date: e, dateProfile: n, todayRange: o, colCnt: t.length, dayHeaderFormat: s })
    ...
    function Xs(e, t) {
        ...
        for (let r of e) {
            let e = r.span || 1;
            for (let i = 0; i < e; i += 1)
                n.push(p("col", { style: { width: "shrink" === r.width ? $s(t) : r.width || "", minWidth: r.minWidth || "" } }));
        }
        return p("colgroup", {}, ...n);
    }
    function $s(e) {
    ...
    function eo(e, t) {
        ...
        return (
            t && e.liquid && null == e.maxHeight && n.push("fc-scrollgrid-section-liquid"), e.isSticky && n.push("fc-scrollgrid-section-sticky"), n
        );
    }
    function to(e) {
    ...
    class io extends Gn {
        ...
        renderSection(e, t, n) {
            return "outerContent" in e
                ...
                : p("tr", { key: e.key, role: "presentation", className: eo(e, this.props.liquid).join(" ") }, this.renderChunkTd(e, t, e.chunk, n));
        }
        ...
        queryHit(e, t, n, r) {
            ...
            return e >= 0 && e < n && t >= 0 && t < r
                ? {
                      ...
                      dateSpan: Object.assign({ allDay: !s.forceTimed, range: { start: s.startDate, end: s.endDate } }, s.extraDateSpan),
                      dayEl: i,
    ...
    var xo = {
        ...
        _o = {
            ...
            cloneElement: function (e, n, r) {
                ...
                for (o in n) "key" == o ? (i = n[o]) : "ref" == o ? (s = n[o]) : (a[o] = n[o]);
                return (
                    arguments.length > 2 && (a.children = arguments.length > 3 ? t.call(arguments, 2) : r), m(e.type, a, i || e.key, s || e.ref, null)
                );
            },
            createElement: p,
            createRef: v,
    ...
    function Wo(e) {
        let t = "function" == typeof e ? { component: e } : e,
            { component: n } = t;
        return (
            t.content ? (n = Lo(t)) : !n || n.prototype instanceof Gn || (n = Lo(Object.assign(Object.assign({}, t), { content: n }))),
            ...
            case "RECEIVE_EVENT_ERROR":
                return (function (e, t, n, r) {
                    ...
                    if (i && n === i.latestFetchId)
                        return Object.assign(Object.assign({}, e), { [t]: Object.assign(Object.assign({}, i), { isFetching: !1, fetchRange: r }) });
                    return e;
    ...
    class ha {
        ...
        resetOptions(e, t) {
            ...
            void 0 === t
                ? (n.optionOverrides = e)
                : ((n.optionOverrides = Object.assign(Object.assign({}, n.optionOverrides || {}), e)), this.optionsForRefining.push(...t)),
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = mn([cn, e, t]),
                ...
                l = (this.currentCalendarOptionsRefiners = Object.assign(
                    Object.assign(Object.assign(Object.assign(Object.assign({}, ln), dn), un), a.listenerRefiners),
                    a.optionRefiners
                )),
                c = {},
                d = mn([cn, o, e, t]),
                ...
                g = !1;
            for (let e in d)
                -1 === this.optionsForRefining.indexOf(e) && (d[e] === h[e] || (hn[e] && e in h && hn[e](h[e], d[e])))
                    ? (u[e] = f[e])
                    : l[e]
                    ? ((u[e] = l[e](d[e])), (g = !0))
                    : (c[e] = h[e]);
        ...
        processRawViewOptions(e, t, n, r, i) {
            let s = mn([cn, e.optionDefaults, n, r, e.optionOverrides, i]),
                o = Object.assign(
                    Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, ln), dn), un), pn), t.listenerRefiners),
                    t.optionRefiners
                ),
                a = {},
    ...
    class Ca extends Gn {
        ...
        render() {
            ...
            return (
                ...
                p(
                    "div",
                    { "aria-labelledby": e.labeledById, ref: this.handleEl, className: r.join(" "), style: { height: i, paddingBottom: s } },
                    e.children
                )
            );
        }
    ...
    class xa extends Mi {
        ...
        triggerEvent(e, t, n) {
            ...
            (t && !r.isValidSegDownEl(t.target)) ||
                i.emitter.trigger(e, { el: n, event: new ti(i, s.eventRange.def, s.eventRange.instance), jsEvent: t, view: i.viewApi });
        }
    }
    class _a extends Vn {
        constructor() {
    ...
    class Pa {
        ...
        recordCoords(e) {
            this.shouldWatchScroll &&
                ((this.prevPageX = e.pageX), (this.prevPageY = e.pageY), (this.prevScrollX = window.scrollX), (this.prevScrollY = window.scrollY));
        }
        destroyScrollWatch() {
    ...
    class Ba {
        ...
        updateElPosition() {
            this.sourceEl &&
                this.isVisible &&
                Be(this.getMirrorEl(), { left: this.sourceElRect.left + this.deltaX, top: this.sourceElRect.top + this.deltaY });
        }
        getMirrorEl() {
                    ...
                    if (l >= 0 && l < u && c >= 0 && c < h) {
                        ...
                        e &&
                            ...
                            (this.disablePointCheck ||
                                a.el.contains(a.el.getRootNode().elementFromPoint(l + n - window.scrollX, c + r - window.scrollY))) &&
                            (!i || e.layer > i.layer) &&
                            ((e.componentId = s),
                            (e.context = o.context),
                            (e.rect.left += n),
    ...
    function Ya(e, t) {
        ...
        return (
            Object.assign(
                n,
                ((r = e),
                { date: (i = t.dateEnv).toDate(r.range.start), dateStr: i.formatIso(r.range.start, { omitTime: r.allDay }), allDay: r.allDay })
            ),
            n
        );
    }
            ...
            super(e),
                        ...
                        i === s || (t.editable && t.droppable)
                            ? ((o = (function (e, t, n, r) {
                                  let i = e.dateSpan,
                                      ...
                                      l = {};
                                  i.allDay !== s.allDay &&
                                      ((l.allDay = s.allDay), (l.hasEnd = t.context.options.allDayMaintainDuration), (o = s.allDay ? Mt(n) : n));
                              ...
                              o &&
                                  ...
                                  (c.mutatedEvents = a),
                                  Ns(c, e.dateProfile, s) || ((l = !0), (o = null), (a = null), (c.mutatedEvents = { defs: {}, instances: {} }))))
                            : (s = null);
                    }
                ...
                (this.handleDragEnd = (e) => {
                    if (this.isDragging) {
                        ...
                        if (
                            (this.clearDrag(), t.emitter.trigger("eventDragStop", { el: this.subjectEl, event: a, jsEvent: e.origEvent, view: n }), i)
                        ) {
                            if (r === t) {
                                ...
                                t.emitter.trigger("eventLeave", Object.assign(Object.assign({}, i), { draggedEl: e.subjectEl, view: n })),
                                ...
                                r.emitter.trigger("eventAdd", g),
                                    ...
                                    r.emitter.trigger(
                                        "eventReceive",
                                        Object.assign(Object.assign({}, g), { draggedEl: e.subjectEl, view: d.context.viewApi })
                                    );
                            }
                ...
                (this.handleDragEnd = (e) => {
                    ...
                    if ((this.clearDrag(), t && n)) {
                        ...
                        if (
                            (t.emitter.trigger(
                                "drop",
                                Object.assign(Object.assign({}, Ya(r.dateSpan, t)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: i })
                            ),
                            s.create)
                        ) {
                            let r = Rr(n);
                    ...
                    super(e),
                        ...
                        (this.handleHitUpdate = (e, t, n) => {
                            ...
                            a &&
                                ...
                                (d.mutatedEvents = l),
                                Ns(d, e.dateProfile, r) || ((c = !0), (a = null), (l = null), (d.mutatedEvents = null))),
                        ...
                        (this.handleDragEnd = (e) => {
                            ...
                            if (
                                (t.emitter.trigger("eventResizeStop", { el: this.draggingSegEl, event: i, jsEvent: e.origEvent, view: t.viewApi }),
                                this.validMutation)
                            ) {
        ...
        render() {
            ...
            return p(
                uo,
                {
                    ...
                    elAttrs: Object.assign(
                        Object.assign(Object.assign({}, t.extraDataAttrs), t.showDayNumber ? { "aria-labelledby": n.dayNumberId } : {}),
                        { role: "gridcell" }
                    ),
                    defaultGenerator: gl,
                    date: o,
                ...
                (s, a) =>
                    p(
                        ...
                        t.showWeekNumber &&
                            p(vo, { elTag: "a", elClasses: ["fc-daygrid-week-number"], elAttrs: qi(e, o, "week"), date: o, defaultFormat: hl }),
    ...
    function vl(e, t, n, r, i, s, o) {
        ...
        let d = a.addSegs(l),
            u = a.toRects(),
            {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    for (let r of a) {
                        let i = t[r.index];
                        l.push({ seg: yl(i, e, e + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: r.levelCoord, marginTop: r.levelCoord - c }),
        ...
        for (let e of c) {
            ...
            for (let t = e.firstCol; t <= e.lastCol; t += 1)
                h[t].push({ seg: yl(e, t, t + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
        ...
        for (let t of d) {
            ...
            for (let e = r.start; e < r.end; e += 1)
                (p[e] += 1), h[e].push({ seg: yl(n, e, e + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
            ...
            if (i)
                for (let o of e) {
                    ...
                    s.push(
                        p(
                            "div",
                            { key: yi(o.eventRange), className: "fc-daygrid-bg-harness", style: e },
            ...
            return p(
                ...
                (e) =>
                    p(
                        ...
                        p(e, { elTag: "div", elClasses: ["fc-timegrid-slot-label-cushion", "fc-scrollgrid-shrink-cushion"] })
                    )
            );
        });
    }
        ...
        renderSimpleLayout(e, t, n) {
            ...
            return (
                ...
                p(
                    ...
                    p(io, { liquid: !i.isHeightAuto && !i.forPrint, collapsibleWidth: i.forPrint, cols: [{ width: "shrink" }], sections: s })
                )
            );
        }
                ...
                t &&
                    ...
                    h.push({
                        ...
                        outerContent: p(
                            "tr",
                            { role: "presentation", className: "fc-scrollgrid-section" },
                            p("td", { colSpan: 2, className: "fc-timegrid-divider " + l.theme.getClass("tableCellShaded") })
                        ),
                    }));
                                    ...
                                    p(
                                        ...
                                        p(Rs, { unit: f ? "minute" : "day" }, (e) => {
                                            ...
                                            return "number" == typeof t
                                                ? p(lo, { elClasses: ["fc-timegrid-now-indicator-arrow"], elStyle: { top: t }, isAxis: !0, date: e })
                                                : null;
                                        })
                                    )
                                ),
    ...
    class jl {
        ...
        computeTimeTop(e) {
            ...
            return (
                (o = Math.max(0, o)), (o = Math.min(s, o)), (t = Math.floor(o)), (t = Math.min(t, s - 1)), (n = o - t), r.tops[t] + r.getHeight(t) * n
            );
        }
    }
    class zl extends Gn {
        ...
        updateSizing() {
            ...
            if (t.onCoords && null !== t.clientWidth) {
                this.rootElRef.current.offsetHeight &&
                    t.onCoords(
                        new jl(
                            new rs(this.rootElRef.current, ((n = this.slatElRefs.currentMap), t.slatMetas.map((e) => n[e.key])), !1, !0),
            ...
            return p(
                ...
                b.map((e) => {
                    ...
                    return p(
                        ...
                        p(
                            Jl,
                            Object.assign({ seg: o, isDragging: n, isResizing: r, isDateSelecting: i, isSelected: c === h, isShort: b }, mi(o, f, g))
                        )
                    );
                })
            );
        ...
        renderFillSegs(e, t) {
            let { props: n, context: r } = this,
                i = Xl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                    ...
                    return p(
                        "div",
                        { key: yi(s.eventRange), className: "fc-timegrid-bg-harness", style: tc(r) },
        ...
        return p(
            ...
            e.map((e) => {
                ...
                return p(
                    ...
                    p(
                        Jl,
                        Object.assign({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: i === r, isShort: !1 }, mi(e, t, n))
                    )
                );
            })
        );
    ...
    class nc extends Gn {
        ...
        updateCoords() {
            ...
            e.onColCoords &&
                null !== e.clientWidth &&
                e.onColCoords(new rs(this.rootElRef.current, ((t = this.cellElRefs.currentMap), e.cells.map((e) => t[e.key])), !0, !1));
        }
    }
    class rc extends ls {
        constructor() {
            super(...arguments),
                ...
                (this.handleRootEl = (e) => {
                    e
                        ? this.context.registerInteractiveComponent(this, { el: e, isHitComboAllowed: this.props.isHitComboAllowed })
                        : this.context.unregisterInteractiveComponent(this);
                }),
                (this.handleScrollRequest = (e) => {
            ...
            return p(
                ...
                (t) =>
                    p(
                        ...
                        p(t, { elTag: "div", elClasses: ["fc-list-day-cushion", e.getClass("tableCellShaded")] })
                    )
            );
        }
    }
                ...
                (e, n) =>
                    p(
                        ...
                        p(
                            ...
                            p("span", { className: "fc-list-event-dot", style: { borderColor: n.borderColor || n.backgroundColor } })
                        ),
                                    ...
                                    p(
                                        ...
                                        (t, n, r, i) => (
                                            ...
                                            p(
                                                ...
                                                p(_a, Object.assign({ isHeightAuto: r, forPrint: i }, e))
                                            )
                                        )
                                    ),
                                    this.el
